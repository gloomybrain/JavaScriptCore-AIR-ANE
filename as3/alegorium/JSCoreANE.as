...
package alegorium
{
	...
	/**
	 * Класс взаимодействия c JavaScriptCore
	 */
	public class JSCoreANE
	{
		/**
		 * Контекст расширения
		 */
		 ...
		 */
		public function JSCoreANE(){
			throw "JSCoreANE instantiation disallowed";
		}
		...
		private static function getContext():ExtensionContext
		{
			...
			try {
				ext = ExtensionContext.createExtensionContext("alegorium.ane.JSCoreANE","");
			} catch(e) { trace(e) }
			return ext;
		}
		 ...
		 * существования контекста исполнения в JavaScriptCore.
		 *
		...
		/**
		 * Очищает память расширения и выгружает движок JSC в том числе
		 */		
